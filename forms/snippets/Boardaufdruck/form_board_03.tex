...
\noindent
  \begin{tikzpicture}
    ...
    \draw[fill=red] (0,1.5) -- (0,3.5) -- (1.5, 5) -- (3, 3.5) -- (3, 1.5) -- (1.5, 0) -- cycle;
    \draw[fill=white] (1.5,5) -- (8.5,5) -- (7, 3.5) -- (3, 3.5) -- cycle;
    \draw[fill=red] (10,3.5) -- (10,1.5) -- (8.5, 0) -- (7, 1.5) -- (7, 3.5) -- (8.5, 5) -- cycle;
    \draw[fill=white] (1.5,0) -- (3,1.5) -- (7, 1.5) -- (8.5, 0) -- cycle;



    \node[very thick, rotate=270, scale=2.5] at (1.5, 2.5) {Nord};
    \node[very thick, rotate=180, scale=2.5] at (5,4.25) {Ost};
    \node[very thick, rotate=90, scale=2.5] at (8.5, 2.5) {Süd};
    \node[very thick, rotate=0, scale=2.5] at (5, 0.75cm) {West};

    \node[very thick, rotate=0, scale=2.5] at (5, 2.5) {Board 1};

  \node[very thick, rotate=45, scale=2] at (9.5, 0.5) {1};
  \node[very thick, rotate=135, scale=2] at (9.5, 4.5) {1};
  \node[very thick, rotate=215, scale=2] at (0.5, 4.5) {1};
  \node[very thick, rotate=305, scale=2] at (0.5, 0.5) {1};
